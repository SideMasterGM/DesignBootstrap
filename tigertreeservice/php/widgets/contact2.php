<div class="bg_2">
<div class="row widget background-light">
	<div class="col-md-12 text-center">
		<h3 class="uppercase t_green-5">get in touch</h3>
		<form action="contact2.php" method="post">
			...
			<div class="row">
				<div class="col-md-12">
					<input type="submit" value="Send Message" class="btn btn-md uppercase t_white b_green-5" data-loading-text="Loading...">
				</div>
			</div>
