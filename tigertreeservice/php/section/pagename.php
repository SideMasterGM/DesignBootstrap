			...
			<div class="col-md-12">
				...
				<h1 itemprop="headline" itemprop="name" class="uppercase t_black breadcumb-title">
					<?php 
			            ...
			            elseif ($page_name=='videos.php') {echo "Videos";}
		    ...
		    <div class="col-md-12">
		    	<ol class="breadcrumb breadcumb-margin" vocab="http://schema.org/" typeof="BreadcrumbList">
		    		<li property="itemListElement" typeof="ListItem">
		    			<a href="index.php" title="Home" property="item" typeof="WebPage" class="uppercase t_green-5"><i class="fa fa-home"></i> <span property="name">Home</span></a>
					  	<meta property="position" content="1">
		    		</li>
		    		<?php if ($page_name=='landing-page.php'){?>
		    		<li property="itemListElement" typeof="ListItem">
		    			<a href="services.php" title="Landing Page" property="item" typeof="WebPage" class="uppercase t_green-5"><span property="name">Services</span></a>
					  	<meta property="position" content="2">
		    		</li>
		    		<?php } elseif ($page_name=='blog-page.php'){?>
		    		<li property="itemListElement" typeof="ListItem">
		    			<a href="blog.php" title="Blog" property="item" typeof="WebPage" class="uppercase t_green-5"><span property="name">Blog</span></a>
					  	<meta property="position" content="2">
		    		</li>
		    		<?php }?>
		    		<li property="itemListElement" typeof="ListItem">
