      ...
      <div class="col-12 col-sm-12 t-color1 text-center1">
        <h3 class="text-center1 t-color5 px-3 mt-3"><?php echo $Company?></h3>
          <p class="px-3">
            ...
            <?php if ($Phone2!='') { ?><a href="<?php echo "$Phone2Ref";?>" class="t-color1" title="<?php echo "$Phone2";?>"><i class="fa fa-phone font-footer"></i> <?php echo "$Phone2".'&emsp;';?></a> <br class="d-block d-sm-none"><?php } ?>
