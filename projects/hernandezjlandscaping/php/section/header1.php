...
<body <?php if($page_name!='blog.php'){echo "itemscope itemtype='http://schema.org/WebPage'";}?>>
  <div class="container py-2 middle-header">
    ...
    <div class="col-lg-6 col-md-8 text-right d-none d-md-block d-lg-block">
      <div class="row">
        <div class="col-md-12 d-none d-sm-block"><a href="<?php echo $PhoneRef;?>" class="t-color3 t-color2-hover"><i class="fa fa-phone"></i> <?php echo $Phone;?></a> 
          &emsp; | &emsp;<i class="fa fa-globe"></i> <?php echo $Address; ?>  
        <!-- &emsp; | &emsp;<a href="<?php echo $Phone2Ref;?>" class="t-color3 t-color2-hover"><i class="fa fa-phone"></i> <?php echo $Phone2;?></a> --></div>
    ...
    <div class="col-lg-2 col-md-2 text-center d-none d-xl-block">
      <a href="contact.php" class="btn btn-md boton4"><strong><i class="fa fa-phone"></i> Get In Touch</strong></a>
    </div>
    </div>
  </div>
  <nav class="navbar navbar-expand-lg navbar-dark main-navbar bg-color4">
        <a class="navbar-brand d-xs-block d-sm-block d-md-block d-lg-none d-lg-none t-color5" href="#">Main Menu</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto">
              <li itemprop="name" class="nav-item <?php echo ($page_name=='index.php')?'active':'';?>">
                <a href="index.php" itemprop="url" title="Home" class="nav-link t-color1 px-4 t-color5-hover"><i class="fa fa-home"></i> Home</a>
              </li>
              <li itemprop="name" class="nav-item <?php echo ($page_name=='about.php')?'active':'';?>">
                <a href="about.php" itemprop="url" title="About Us" class="nav-link t-color1 px-4 t-color5-hover"><i class="fa fa-user"></i> About</a>
              </li>
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle t-color1 px-4 t-color5-hover" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-plus"></i> Services</a>
              ...
              <!-- <li itemprop="name" class="nav-item <?php echo ($page_name=='services.php')?'active':'';?>">
                <a href="services.php" itemprop="url" title="Our Services" class="nav-link t-color1 px-4 t-color5-hover"><i class="fa fa-plus"></i> Services</a>
              </li> -->
              <li itemprop="name" class="nav-item <?php echo ($page_name=='portfolio.php')?'active':'';?>">
                <a href="portfolio.php" itemprop="url" title="Our Portfolio" class="nav-link t-color1 px-4 t-color5-hover"><i class="fa fa-image"></i> Portfolio</a>
              </li>
             <!--  <li itemprop="name" class="nav-item <?php echo ($page_name=='testimonials.php')?'active':'';?>">
              ...
              <li itemprop="name" class="nav-item <?php echo ($page_name=='contact.php')?'active':'';?>">
                <a href="contact.php" itemprop="url" title="Contact" class="nav-link t-color1 px-4 t-color5-hover"><i class="fa fa-address-book"></i> Contact</a>
              </li>
             <!--  <li class="nav-item dropdown">
