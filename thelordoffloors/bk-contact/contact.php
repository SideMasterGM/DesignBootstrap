					...
					<div class="row" itemprop="text">
						<div class="col-md-7">
							...
							<form action="contact2.php" method="post">
								...
								<div class="row">
									<div class="col-md-12">
										<input required type="submit" value="Send Message" class="btn  b_gold b_brown-3-hover t_brown-6" data-loading-text="Loading...">
									</div>
								</div>
						...
						<div class="col-md-5">
							...
							<div class="row">
								<div class="col-md-12 col-sm-12">
									...
									<p><i class="fa fa-phone"></i> <a href="<?php echo "$PhoneRef";?>" title="<?php echo "$Phone";?>" class="t_brown-4"><?php echo "$Phone";?></a></p>
									<!-- <p><i class="fa fa-phone"></i> <a href="<?php echo "$PhoneRef2";?>" title="<?php echo "$Phone2";?>"><?php echo "$Phone2";?></a></p> -->
									<!-- <p><i class="fa fa-phone"></i> <a href="<?php echo "$PhoneRef3";?>" title="<?php echo "$Phone3";?>"><?php echo "Phone2: $Phone3";?></a></p> -->
									<p><i class="fa fa-envelope"></i> <a href="<?php echo "$MailRef";?>" title="<?php echo "$Mail";?>" class="t_brown-4"><?php echo "$Mail";?></a></p>
									<p><i class="fa fa-envelope"></i> <a href="mailto:<?php echo "$Mail2";?>" title="<?php echo "$Mail2";?>" class="t_brown-4"><?php echo "$Mail2";?></a></p>
									<!--<p><i class="fa fa-file"></i> <?php echo "$License | $License2";?></p>-->
								...
								<div class="col-md-12 col-sm-12">
									...
									<!--<p><i class="fa fa-check"></i> <?php echo "$Satisfaction";?></p>-->
