<div class="bars b_gray-6">
	<div class="container">
		<div class="col-md-6 t_white" data-animation="fadeInLeft">
			<h2 class="t_green-3">About Us</h2>
			<div><?php echo "$ExAbout";?></div>
			<a href="about.php" title="about" class="btn btn-md b_blue-1 b_blue-2-hover t_white"><i class="fa fa-eye"></i> Read More</a>
			<br><br>
		</div>
		<div class="col-md-6 animation fadeInDown animation-visible" data-animation="fadeInDown">
			<div class="title-accent">
				<h3 class="t_white"><span>Why</span> choose us</h3>
			</div>
			<div class="tabs">
