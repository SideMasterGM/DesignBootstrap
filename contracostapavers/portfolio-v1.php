...
<ul class="pagination">
  <li ><a class="btn btn-md btn-warning mr-2" href="portfolio.php?page=<?php echo $prev; ?>">&laquo;</a></li>
  <?php for ($i = 1; $i <= $numero_paginas; $i++) { ?>
  <li class="<?php if($pagina_actual==$i){ echo "active"; }?>"><a class="btn btn-md btn-warning mr-2" href="portfolio.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
  <?php } ?>
  <li><a class="btn btn-md btn-warning mr-2" href="portfolio.php?page=<?php echo $next; ?>">&raquo;</a></li>
</ul>
<?php } ?>
